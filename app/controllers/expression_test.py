...
def expression_controller(params):
    ...
    print("After regex substitution:", raw_expression)

    expression = Expression(raw_expression=raw_expression)

    params = {'raw_expression': raw_expression}
...
# params = {"raw_expression": "x ** 2 + 5 * x - 6"}
# expression_controller(params)
params = {"raw_expression": "3x2+5x-6"}
expression_controller(params)
